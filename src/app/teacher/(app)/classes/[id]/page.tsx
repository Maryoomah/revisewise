    ...
    <main className="min-h-screen bg-gray-50 px-4 py-8 sm:px-6 sm:py-10">
        ...
        <div className="mt-6 rounded-2xl bg-white p-5 shadow-sm sm:p-8">
          <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
            <div className="min-w-0">
              <h1 className="mt-1 wrap-break text-3xl font-bold text-gray-900 sm:text-4xl">
                {classItem.title}
              </h1>
          ...
          <div className="mt-8 rounded-xl bg-blue-50 p-4 sm:p-5">
            ...
            <div className="mt-2 flex flex-wrap items-center gap-3">
              <p className="min-w-0 break-all text-2xl font-bold tracking-widest text-blue-950">
                {classItem.join_code}
              </p>
      ...
      <section className="mx-auto mt-8 max-w-6xl sm:mt-10">
        ...
        {assignments.length === 0 ? (
          <section className="rounded-xl bg-white p-8 text-center shadow-sm sm:p-10">
          ...
          <section className="grid grid-cols-1 gap-6 md:grid-cols-2">
            {assignments.map((assignment) => (
              <article
                key={assignment.id}
                className="rounded-2xl bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md sm:p-6"
              >
